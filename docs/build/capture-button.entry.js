...
const CaptureButton = class {
    ...
    render() {
        return (h(Host, { onMouseUp: this.onMouseUp.bind(this), onMouseDown: this.onMouseDown.bind(this), onTouchStart: this.onMouseUp.bind(this), onTouchEnd: this.onMouseDown.bind(this), recording: this.isRecording }, h("button", null)));
    }
    onMouseDown() {
