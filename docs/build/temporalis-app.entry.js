...
const TemporalisApp = class {
    ...
    render() {
        return (h(Host, null, h("canvas-recorder", null, h("slit-scan", { mode: this.mode, slices: this.slices, cameraId: this.cameraId, mirror: this.mirror })), h("input", { id: "slices", type: "range", min: "20", value: this.slices, max: "500", onInput: this.onChangeSlices.bind(this) }), h("button", { id: "switch-cam", title: "switch camera", onClick: this.onClickSwitchCam.bind(this) }), h("button", { id: "fullscreen", title: "fullscreen", onClick: this.onClickFullscreen.bind(this) }), h("button", { id: "mode", title: "change mode", onClick: this.onClickToggleMode.bind(this), "data-mode": this.mode }), h("capture-button", { title: "capture", onSnapshot: this.onClickSnapshot.bind(this), onRecordStart: this.onRecordStart.bind(this), onRecordEnd: this.onRecordEnd.bind(this) })));
    }
